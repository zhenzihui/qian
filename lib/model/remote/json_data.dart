...
class GoodsRequest extends BaseRequest {
  ...
  Map<String, dynamic> toMap() => super.toMap()
    ..addAll({
      ...
      ..addAllIf(goodsType != null, {"goods_type": goodsType}));
}

class GetGoodsLinkRequest extends BaseRequest {
  //租户标识
  ...
  GetGoodsLinkRequest(
      {this.identity = "platform_default",required this.goodsLink});

  @override
  Map<String, dynamic> toMap() =>
      super.toMap()..addAll({"goods_link": goodsLink, "sid": identity});
}
